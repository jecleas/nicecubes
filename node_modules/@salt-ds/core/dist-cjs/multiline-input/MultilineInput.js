...
const MultilineInput = React.forwardRef(
  function MultilineInput2({
    ...
    const handleInputElement = React.useCallback(
      (element) => {
        setInputElement(element);
      },
      []
    );
    const handleRef = useForkRef.useForkRef(handleInputElement, textAreaRef);
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: withBaseName("wrapper"), children: /* @__PURE__ */ jsxRuntime.jsx(
            "textarea",
            {
              "aria-describedby": clsx.clsx(formFieldDescribedBy, textAreaDescribedBy) || void 0,
              "aria-labelledby": clsx.clsx(formFieldLabelledBy, textAreaLabelledBy) || void 0,
