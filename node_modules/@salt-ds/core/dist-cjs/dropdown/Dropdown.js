...
function ExpandIcon({ open }) {
  ...
  return open ? /* @__PURE__ */ jsxRuntime.jsx(CollapseIcon, { className: withBaseName("toggle"), "aria-hidden": true }) : /* @__PURE__ */ jsxRuntime.jsx(ExpandIcon2, { className: withBaseName("toggle"), "aria-hidden": true });
}
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        ...
        children: [
          ...
          !disabled && validationStatus && /* @__PURE__ */ jsxRuntime.jsx(StatusAdornment.StatusAdornment, { status: validationStatus }),
          !readOnly && /* @__PURE__ */ jsxRuntime.jsx(ExpandIcon, { open: openState }),
