...
const CompactPaginator = React.forwardRef(function CompactPaginator2({ children, className, ...restProps }, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: clsx.clsx(withBaseName(), className), ...restProps, ref, children: [
    ...
    children ? children : /* @__PURE__ */ jsxRuntime.jsx(PageButton.PageButton, { page, disabled: true }),
    /* @__PURE__ */ jsxRuntime.jsx(Text.Text, { as: "span", variant: "secondary", children: "of" }),
    /* @__PURE__ */ jsxRuntime.jsx(PageButton.PageButton, { page: count, disabled: isOnLastPage }),
    /* @__PURE__ */ jsxRuntime.jsx(
      Button.Button,
      {
        appearance: "transparent",
