...
const ListBox = React.forwardRef(function ListBox2(props, ref) {
  ...
  const handleRef = useForkRef.useForkRef(setListRef, ref);
  return /* @__PURE__ */ jsxRuntime.jsx(ListControlContext.ListControlContext.Provider, { value: listControl, children: /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      className: clsx.clsx(
        withBaseName(),
